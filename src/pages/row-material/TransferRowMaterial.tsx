...
const PRODUCT_TYPE = InventoryDocumentProductType.MATERIAL;
...
export default function TransferRowMaterial() {
  ...
  }, [appliedSearchText, loadSearchState, searchFilters, searchState, showFlash]);
  ...
  return (
    <PageShell>
      <PageTitle title="Suministros - Transferencias" />
      <div className="space-y-4">
        ...
        <DataTable
          tableId="inventory-documents-transfer-materiales"
          data={documentRows}
          columns={columns}
          rowKey="id"
          loading={loading}
