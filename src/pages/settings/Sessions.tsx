...
const Sessions = () => {
    ...
    return (
        <div className="page-shell flex items-start justify-center">
            ...
            {openModal && (
                <Modal onClose={() => setOpenModal(false)} title={oneSession ? "¿Está seguro de cerrar la sesión?" : "¿Está seguro de cerrar todas sus sesiones?"}>
                    <p className="mt-0 text-slate-500">{oneSession ? "Esto cerrará la sesión." : "Esto cerrará todas sus sesiones activas en otros dispositivos."}</p>
