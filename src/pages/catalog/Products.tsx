          ...
          <div className="hidden lg:block">
            <div className="max-h-[calc(100vh-340px)] overflow-auto">
              ...
              {products.length === 0 && !loading && (
                <div className="px-5 py-8 text-sm text-black/60">No hay productos con los filtros actuales.</div>
              )}
        ...
        <Modal title="Confirmar acción" onClose={() => setDeletingProductId(null)} className="max-w-md">
          ...
          >
            ...
            <p className="mt-3 text-sm text-black/70">
              ¿Confirmas esta acción? Puede afectar reportes, catálogo visible y procesos internos.
            </p>
        ...
        <Modal title={`Variantes · ${variantsProduct.name}`} onClose={closeVariantsModal} className="max-w-xl">
          ...
          >
            ...
            {!variantsLoading && variants.length === 0 && !variantsError && (
              <p className="text-sm text-black/60">No hay variantes para este producto.</p>
            )}
