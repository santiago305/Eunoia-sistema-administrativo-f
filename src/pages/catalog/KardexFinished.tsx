...
import { LedgerSmartSearchPanel } from "./components/LedgerSmartSearchPanel";
import {
...
} from "./utils/ledgerSmartSearch";

const PRIMARY = "hsl(var(--primary))";
const RECENT_STORAGE_KEY = "recent-search:catalog-kardex";
                            ...
                            toolbarSearchContent={
                                <div className="space-y-3">
                                  <DataTableSearchBar
                                    ...
                                    searchName="catalog-kardex-smart-search"
                                  >
