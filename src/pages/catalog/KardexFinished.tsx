...
export default function KardexFinished() {
  ...
  return (
    <PageShell>
      <PageTitle title="Movimientos de productos" />

      <div className="grid grid-cols-2 ms:grid-cols-1 gap-3 pt-2 items-center">
        <Headed title="Movimientos de productos" subtitle="Auditoría interna del inventario." size="lg" />
      </div>
      ...
      <div className="space-y-3">
        ...
        <DataTable
          ...
          rangeDates={{
            ...
            name: "inventory-ledger-products-date-range",
