...
export default function DocumentProduts() {
    ...
    const loadDocuments = async () => {
        ...
        try {
            const res = await getDocuments({
                ...
                productType: ProductTypes.FINISHED,
                ...
                <section className="grid grid-cols-1 xl:grid-cols-[2fr_0.5fr] gap-4">
                    <div className="space-y-4">
                        ...
                        <section className="overflow-hidden rounded-2xl border border-black/10 bg-white shadow-sm">
                            <DataTable
                                tableId="document-products-list"
                                data={documentRows}
                                columns={columns}
                                rowKey="id"
                                loading={loading}
                                ...
                                tableClassName="text-[10px] rounded-2xl"
                    ...
                    <aside className="space-y-4">
                        <div className="rounded-2xl border border-black/10 bg-white p-5 shadow-sm">
                            ...
                            <div className="mt-3 grid grid-cols-1 gap-2">
                                <SystemButton
                                    className="text-xs"
                                    onClick={() => navigate(RoutesPaths.catalogAdjustments)}
                                >
                                    Ajuste
                                </SystemButton>
                                <SystemButton
                                    className="text-xs"
                                    onClick={() => navigate(RoutesPaths.catalogTransfer)}
                                >
                                    Transferencia
                                </SystemButton>
                            </div>
