...
import type { CreditQuota, Payment } from "@/pages/purchases/types/purchase";
import type { AfectTypeType, CurrencyType, PaymentFormType, PurchaseOrderStatus, VoucherDocType } from "@/pages/purchases/types/purchaseEnums";
