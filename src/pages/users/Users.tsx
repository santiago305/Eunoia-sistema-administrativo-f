...
export default function Users() {
    ...
    return (
        <div className="max-h-screen w-full bg-white text-black flex flex-col overflow-hidden">
            ...
            <div className="px-10 flex flex-col flex-1 overflow-hidden mb-2">
                ...
                <div
                 ...
                 shadow-[0_1px_4px_0_hsla(0,0%,0%,0.1)] min-w-[860px]"
                >
                    <div className="w-full h-full min-w-[860px]">
                        <table className="w-full min-w-[860px] h-full border-separate border-spacing-0 table-fixed">
                            <thead className="bg-green-200 font-semibold text-[18px]">
                                <tr className="h-14">
                                    <th className="px-5 text-left text-gray-600 w-[25%]">Nombre</th>
                                    <th className="px-5 text-left text-gray-600 w-[35%]">Email</th>
                                    <th className="px-5 text-left text-gray-600 w-[20%]">Rol</th>
                                    <th className="px-5 text-center text-gray-600 w-[20%]">Opciones</th>
                                </tr>
                            </thead>
                            <tbody className="">
                ...
                <div className="mt-2 flex items-center justify-center">
                    <div className="inline-flex items-center gap-3 rounded-2xl bg-gray-100 px-4 py-2 ">
                        <button
