...
export default function CreateUserPage() {
    ...
    const handleSubmit = async (data: UpdateUserDto) => {
        ...
        try {
            ...
            const res = successResponse(isEdit ? "Usuario actualizado correctamente" : "Usuario creado correctamente");
            showFlash(res);
            return res;
        } catch (error) {
            const res = errorResponse(isEdit ? "No se pudo actualizar el usuario" : "No se pudo crear el usuario");
            showFlash(res);
            throw error;
        }
    };
    ...
    return (
        <div className="h-full w-full flex items-start justify-start bg-white">
            <div className="w-full mt-10 max-w-2xl overflow-hidden rounded-2xl  bg-gray-50 shadow-lg">
