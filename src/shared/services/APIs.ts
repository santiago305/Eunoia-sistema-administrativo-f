...
export const API_NOTIFICATIONS_GROUP = {
  ...
  byId: (id: string) => `/email/${id}`,
  markSeen: (id: string) => `/email/${id}/seen`,
  markRead: (id: string) => `/email/${id}/read`,
  markAllRead: "/email/read-all",
  archive: (id: string) => `/email/${id}/archive`,
  devSendToMe: "/email/dev/send-to-me",
};

export const API_NOTIFICATION_MESSAGES_GROUP = {
  modules: "/email/modules",
  listMessages: "/email/messages",
  getMessageDetail: (id: string) => `/email/messages/${id}`,
  sendMessage: "/email/messages",
  markMessageRead: (id: string) => `/email/messages/${id}/read`,
  markMessageUnread: (id: string) => `/email/messages/${id}/unread`,
  starMessage: (id: string) => `/email/messages/${id}/star`,
  unstarMessage: (id: string) => `/email/messages/${id}/unstar`,
  deleteMessage: (id: string) => `/email/messages/${id}`,
  permanentlyDeleteMessage: (id: string) => `/email/messages/${id}/permanent`,
  restoreMessage: (id: string) => `/email/messages/${id}/restore`,
  archiveMessage: (id: string) => `/email/messages/${id}/archive`,
  unarchiveMessage: (id: string) => `/email/messages/${id}/unarchive`,
  snoozeMessage: (id: string) => `/email/messages/${id}/snooze`,
  unsnoozeMessage: (id: string) => `/email/messages/${id}/unsnooze`,
  bulkMessages: "/email/messages/bulk",
  replyMessage: (id: string) => `/email/messages/${id}/reply`,
  forwardMessage: (id: string) => `/email/messages/${id}/forward`,
  listDrafts: "/email/drafts",
  createDraft: "/email/drafts",
  updateDraft: (id: string) => `/email/drafts/${id}`,
  deleteDraft: (id: string) => `/email/drafts/${id}`,
