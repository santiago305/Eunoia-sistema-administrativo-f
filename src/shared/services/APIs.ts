...
export const agencyRoutes = {
  ...
  withSubsidiaries: (id: string) => `/agencies/${id}/with-subsidiaries`,
...
export const API_NOTIFICATION_MESSAGES_GROUP = {
  ...
  getMyStorageSummary: "/mail/storage/me",
  updateMyStorageQuota: "/mail/storage/me/quota",
  getUserStorageSummary: (id: string) => `/mail/storage/users/${id}`,
  updateUserStorageQuota: (id: string) => `/mail/storage/users/${id}/quota`,
  listMyFiles: "/mail/files",
  deleteMyFile: (attachmentId: string) => `/mail/files/${attachmentId}`,
  bulkDeleteMyFiles: "/mail/files/bulk-delete",
  ...
  unstarMessage: (id: string) => `/mail/messages/${id}/unstar`,
  deleteMessage: (id: string) => `/mail/messages/${id}`,
  permanentlyDeleteMessage: (id: string) => `/mail/messages/${id}/permanent`,
  restoreMessage: (id: string) => `/mail/messages/${id}/restore`,
  archiveMessage: (id: string) => `/mail/messages/${id}/archive`,
  unarchiveMessage: (id: string) => `/mail/messages/${id}/unarchive`,
  snoozeMessage: (id: string) => `/mail/messages/${id}/snooze`,
  unsnoozeMessage: (id: string) => `/mail/messages/${id}/unsnooze`,
  bulkMessages: "/mail/messages/bulk",
  replyMessage: (id: string) => `/mail/messages/${id}/reply`,
  forwardMessage: (id: string) => `/mail/messages/${id}/forward`,
  listDrafts: "/mail/drafts",
  createDraft: "/mail/drafts",
  updateDraft: (id: string) => `/mail/drafts/${id}`,
  deleteDraft: (id: string) => `/mail/drafts/${id}`,
  sendDraft: (id: string) => `/mail/drafts/${id}/send`,
  listLabels: "/mail/labels",
  createLabel: "/mail/labels",
  ...
  uploadAttachment: "/mail/attachments",
  downloadAttachment: (id: string) => `/mail/attachments/${id}/download`,
  deleteAttachment: (id: string) => `/mail/attachments/${id}`,
};
...
export const API_SALE_ORDERS_GROUP = {
  ...
  adviserImportAliases: "/sale-orders/adviser-import-aliases",
  adviserImportAlias: (id: string) => `/sale-orders/adviser-import-aliases/${id}`,
  resolveImportAdvisers: "/sale-orders/adviser-import-aliases/resolve",
