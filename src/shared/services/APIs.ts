...
export const API_NOTIFICATION_MESSAGES_GROUP = {
  ...
  markMessageUnread: (id: string) => `/api/notifications/messages/${id}/unread`,
  starMessage: (id: string) => `/api/notifications/messages/${id}/star`,
  unstarMessage: (id: string) => `/api/notifications/messages/${id}/unstar`,
  deleteMessage: (id: string) => `/api/notifications/messages/${id}`,
  permanentlyDeleteMessage: (id: string) => `/api/notifications/messages/${id}/permanent`,
  restoreMessage: (id: string) => `/api/notifications/messages/${id}/restore`,
  archiveMessage: (id: string) => `/api/notifications/messages/${id}/archive`,
  unarchiveMessage: (id: string) => `/api/notifications/messages/${id}/unarchive`,
  snoozeMessage: (id: string) => `/api/notifications/messages/${id}/snooze`,
  unsnoozeMessage: (id: string) => `/api/notifications/messages/${id}/unsnooze`,
  bulkMessages: "/api/notifications/messages/bulk",
  replyMessage: (id: string) => `/api/notifications/messages/${id}/reply`,
  forwardMessage: (id: string) => `/api/notifications/messages/${id}/forward`,
  listDrafts: "/api/notifications/drafts",
  createDraft: "/api/notifications/drafts",
  updateDraft: (id: string) => `/api/notifications/drafts/${id}`,
  deleteDraft: (id: string) => `/api/notifications/drafts/${id}`,
  ...
  uploadAttachment: "/api/notifications/attachments",
  downloadAttachment: (id: string) => `/api/notifications/attachments/${id}/download`,
  deleteAttachment: (id: string) => `/api/notifications/attachments/${id}`,
};
