  ...
  return (
    <PageShell>
      ...
      <AlertModal
        ...
        title={clientPendingToggle?.isActive ? "Desactivar cliente" : "Reactivar cliente"}
        message={
          clientPendingToggle?.isActive
            ? "Estas por desactivar este cliente. Hazlo solo si estas seguro."
            : "Estas por reactivar este cliente. Hazlo solo si estas seguro."
        }
        confirmText={clientPendingToggle?.isActive ? "Desactivar" : "Reactivar"}
