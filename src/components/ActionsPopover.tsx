  ...
  return (
    <>
      <button
        ...
        className={cn(
          "inline-flex cursor-pointer items-center justify-center rounded-md transition-all duration-200 disabled:pointer-events-none disabled:opacity-50",
        ...
        <div className={cn("grid gap-2", getColumnsClass(columns), gridClassName)}>
          {visibleActions.map((action) => {
            ...
            const sharedClassName = cn(
              "group flex w-full cursor-pointer items-center justify-center gap-2 rounded-md text-center text-foreground transition-all hover:bg-muted focus:outline-none focus:ring-2 focus:ring-ring/40 disabled:pointer-events-none disabled:opacity-45",
              action.danger && "text-red-600 hover:bg-red-500/10 hover:text-red-600",
              itemClassName,
              action.className,
            );
            ...
            const content = (
              <>
                ...
                {action.badge ? <div className="mt-0.5">{action.badge}</div> : null}
              </>
            );
