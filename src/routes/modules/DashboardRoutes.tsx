...
const AdminFinancePage = lazy(() => import("@/features/admin-finance/AdminFinancePage"));
...
const Advisers = lazy(() => import("@/features/advisers/Advisers"));
...
export const dashboardRoutes: RouteObject[] = [
    {
        ...
        children: [
            ...
            {
                path: RoutesPaths.adminFinance,
                element: withRouteGuard(RoutesPaths.adminFinance, <AdminFinancePage />),
            },
            {
                path: RoutesPaths.accountsPayable,
                element: withRouteGuard(RoutesPaths.accountsPayable, <AccountsPayablePage />),
            },
            {
            ...
            {
                path: RoutesPaths.advisers,
                element: withCompanyRouteGuard(RoutesPaths.advisers, <Advisers />),
            },
            {
