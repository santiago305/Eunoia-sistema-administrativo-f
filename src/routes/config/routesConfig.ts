...
export const routesConfig: RouteMetadata[] = [
  ...
  { path: RoutesPaths.purchaseDashboard, name: "purchaseDashboard", isProtected: true, permissionsAllowed: ["page.purchases.view"] },
  { path: RoutesPaths.purchaseCreate, name: "purchaseCreate", isProtected: true, permissionsAllowed: ["page.purchases.view"] },
  ...
  { path: RoutesPaths.recurringPurchases, name: "recurringPurchases", isProtected: true, permissionsAllowed: ["page.purchases.view"] },
  ...
  { path: RoutesPaths.purchasePayments, name: "purchasePayments", isProtected: true, permissionsAllowed: ["page.purchases.view", "page.payments.view"] },
  { path: RoutesPaths.purchaseDocuments, name: "purchaseDocuments", isProtected: true, permissionsAllowed: ["page.purchases.view"] },
  { path: RoutesPaths.purchaseDetail, name: "purchaseDetail", isProtected: true, permissionsAllowed: ["page.purchases.view"] },
  ...
  { path: RoutesPaths.accountsPayable, name: "accountsPayable", isProtected: true, permissionsAllowed: ["page.accounts-payable.view"] },
  { path: RoutesPaths.paymentAccounts, name: "paymentAccounts", isProtected: true, permissionsAllowed: ["page.payment-accounts.view"] },
