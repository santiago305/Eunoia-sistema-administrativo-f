...
export const routesConfig: RouteMetadata[] = [
  ...
  { path: RoutesPaths.rowMaterialInventory, name: "rowMaterialInventory", isProtected: true, permissionsAllowed: ["page.material-inventory.view"] },
  { path: RoutesPaths.rowMaterialDocuments, name: "rowMaterialDocumentsLegacy", isProtected: true, permissionsAllowed: ["page.material-inventory.view"] },
  ...
  { path: RoutesPaths.advisers, name: "advisers", isProtected: true, permissionsAllowed: ["page.advisers.view", "advisers.view"] },
