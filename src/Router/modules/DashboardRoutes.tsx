...
const CatalogSummary = lazy(() => import("@/pages/catalog/products/Summary"));
const CatalogProducts = lazy(() => import("@/pages/catalog/products/Products"));
const CatalogTransferences = lazy(() => import("@/pages/catalog/products/TransferProduts"));
const CatalogAdjustments = lazy(() => import("@/pages/catalog/products/AdjustmentProduts"));
const CatalogAdjustment = lazy(() => import("@/pages/catalog/products/components/AdjustmentFormProducts"));
...
const RowMaterial = lazy(() => import("@/pages/catalog/raw-material/RowMaterial"));
const RowMaterialSummary = lazy(() => import("@/pages/catalog/raw-material/SummaryRow"));
const RowMaterialAdjustments = lazy(() => import("@/pages/catalog/raw-material/AdjustmentRowMaterials"));
const RowMaterialDocuments = lazy(() => import("@/pages/catalog/raw-material/InventoryRowMaterial"));
...
const KardexPrima = lazy(() => import("@/pages/catalog/raw-material/KardexPrima"));
const KardexFinished = lazy(() => import("@/pages/catalog/products/KardexFinished"));
const TransferProduct = lazy(() => import("@/pages/catalog/products/components/TransferFormProducts"));
const TransferRowMaterial = lazy(() => import("@/pages/catalog/raw-material/TransferRowMaterial"));
const OutOrder = lazy(() => import("@/pages/out-orders/OutOrder"));
const CatalogInventory = lazy(() => import("@/pages/catalog/products/Inventory"));
