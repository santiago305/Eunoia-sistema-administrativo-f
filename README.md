...
La interfaz de Pedidos consume la matriz backend y oculta rutas, columnas, controles y acciones según permisos. Preguía y preparación son indicadores de solo lectura y se modifican mediante las acciones globales del flujo; restaurar requiere `sale_orders.view_deleted` y `sale_orders.restore`. La referencia completa está en `../Eunoia-sistema-administrativo-b/docs/sale-orders-role-matrix.md`.
